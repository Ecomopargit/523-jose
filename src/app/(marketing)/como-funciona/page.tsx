  ...
  return (
    <main className="min-h-screen">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <span className="text-[#1FA35B] font-semibold text-sm uppercase tracking-wider">O Modelo</span>
          ...
          <div className="grid lg:grid-cols-3 gap-8 items-center">
            ...
            <div className="bg-gradient-to-br from-[#F5F7FA] to-white rounded-2xl p-8 border border-gray-100 text-center relative">
              <div className="w-16 h-16 bg-[#0E3A5D] rounded-2xl flex items-center justify-center mx-auto mb-6">
                <Wallet className="w-8 h-8 text-white" />
              </div>
              <h3 className="text-xl font-bold text-[#0E3A5D] mb-3">Depósito Diário</h3>
              <p className="text-gray-600 mb-4">
                Você realiza um depósito diário de <strong className="text-[#0E3A5D]">R$ 7,00</strong> via PIX
              </p>
              <div className="text-3xl font-bold text-[#0E3A5D]">R$ 7,00</div>
              <div className="text-sm text-gray-500">por dia</div>
            </div>

            {/* Seta */}
            <div className="hidden lg:flex justify-center">
              <ArrowRight className="w-12 h-12 text-[#1FA35B]" />
            </div>

            {/* Divisão */}
            <div className="bg-gradient-to-br from-[#0E3A5D] to-[#1a5a3d] rounded-2xl p-8 text-white">
              <h3 className="text-xl font-bold mb-6 text-center">Distribuição</h3>
              <div className="space-y-4">
                <div className="flex items-center justify-between bg-white/10 rounded-xl p-4">
                  <div className="flex items-center space-x-3">
                    <PiggyBank className="w-6 h-6 text-[#1FA35B]" />
                    <span>Sua Reserva</span>
                  </div>
                  <span className="text-2xl font-bold text-[#1FA35B]">R$ 5,00</span>
                </div>
                <div className="flex items-center justify-between bg-white/10 rounded-xl p-4">
                  <div className="flex items-center space-x-3">
      ...
      <section className="py-20 bg-[#F5F7FA]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <span className="text-[#1FA35B] font-semibold text-sm uppercase tracking-wider">Simulação</span>
            <h2 className="text-3xl lg:text-4xl font-bold text-[#0E3A5D] mt-3">
              Exemplo prático
            </h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white rounded-2xl p-8 shadow-sm text-center">
              ...
              <div className="text-4xl font-bold text-[#0E3A5D] mb-2">R$ 150,00</div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm text-center border-2 border-[#1FA35B]">
              <div className="text-sm text-gray-500 mb-2">Em 6 meses</div>
              <div className="text-4xl font-bold text-[#1FA35B] mb-2">R$ 900,00</div>
              <div className="text-sm text-gray-600">acumulados na reserva</div>
              <div className="mt-4 pt-4 border-t text-sm text-gray-500">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm text-center">
              ...
              <div className="text-4xl font-bold text-[#0E3A5D] mb-2">R$ 1.800,00</div>
              <div className="text-sm text-gray-600">acumulados na reserva</div>
              <div className="mt-4 pt-4 border-t text-sm text-gray-500">
          ...
          <div className="mt-12 bg-white rounded-2xl p-8 shadow-sm">
            <h3 className="text-xl font-bold text-[#0E3A5D] mb-6 text-center">
              Fluxo Completo
            </h3>
            <div className="grid md:grid-cols-5 gap-4">
              {[
                ...
                <div key={index} className="text-center">
                  <div className="w-10 h-10 bg-gradient-to-br from-[#0E3A5D] to-[#1FA35B] rounded-full flex items-center justify-center mx-auto mb-3">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12">
            <div>
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-4 p-4 bg-green-50 rounded-xl">
                  ...
                  <div>
                    <h4 className="font-bold text-[#0E3A5D]">Saque da Reserva</h4>
                ...
                <div className="flex items-start space-x-4 p-4 bg-yellow-50 rounded-xl">
                  ...
                  <div>
                    <h4 className="font-bold text-[#0E3A5D]">Bloqueio de 90 Dias</h4>
                    <p className="text-gray-600 text-sm">
                ...
                <div className="flex items-start space-x-4 p-4 bg-blue-50 rounded-xl">
                  <CheckCircle className="w-6 h-6 text-[#0E3A5D] flex-shrink-0 mt-0.5" />
                  <div>
                    <h4 className="font-bold text-[#0E3A5D]">Transparência Total</h4>
                    <p className="text-gray-600 text-sm">
            ...
            <div className="bg-gradient-to-br from-[#0E3A5D] to-[#1a5a3d] rounded-3xl p-8 text-white">
